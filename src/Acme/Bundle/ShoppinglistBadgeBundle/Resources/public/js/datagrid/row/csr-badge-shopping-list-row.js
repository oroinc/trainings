...
import csrBadgeRowTemplate from 'tpl-loader!acmeshoppinglistbadge/templates/datagrid/row/csr-badge-row.html';

const CsrBadgeShoppingListRow = ShoppingListRow.extend({
    constructor: function CsrBadgeShoppingListRow(options) {
        CsrBadgeShoppingListRow.__super__.constructor.call(this, options);
    },
