...
import UserStatsSubview from 'acmefrontenddashboards/js/app/views/users-stats-view';
import OrdersView from 'acmefrontenddashboards/js/app/views/orders-view';
