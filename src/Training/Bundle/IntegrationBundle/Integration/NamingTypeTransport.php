...
use Training\Bundle\IntegrationBundle\Entity\UserNamingIntegrationSettings;
use Training\Bundle\IntegrationBundle\Form\Type\NamingTypeIntegrationSettingsType;
...
class NamingTypeTransport implements TransportInterface
{
    ...
    {
        return 'training.integration.settings.label';
    }
