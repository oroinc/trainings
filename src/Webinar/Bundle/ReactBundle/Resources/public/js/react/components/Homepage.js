                        ...
                        <div className="bg-gray-900">
                            <div className="max-w-7xl mx-auto h-10 px-4 flex items-center justify-between sm:px-6 lg:px-8">
                                ...
                                <div className="flex items-center space-x-6">
                                    <a href={routing.generate('oro_customer_customer_user_security_login')} className="text-sm font-medium text-white hover:text-gray-100">
                                        Sign in
                                    </a>
                                    <a href={routing.generate('oro_customer_frontend_customer_user_register')} className="text-sm font-medium text-white hover:text-gray-100">
                                        Create an account
                                    </a>
                                </div>
                            </div>
